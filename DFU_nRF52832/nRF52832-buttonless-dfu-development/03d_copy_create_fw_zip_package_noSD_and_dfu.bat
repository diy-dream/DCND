...
SET APPLICATION_HEX=ble_app_dcnd_sparkfun_nrf52832_s132.hex
...
nrfutil pkg generate --application %APPLICATION_HEX% --application-version 1 --application-version-string "1.0.0" --hw-version 52 --sd-req 0xCB --key-file private.pem %PACKAGE_NAME%
echo.
