...
nrfutil pkg generate --application %APPLICATION_HEX% --application-version 1 --application-version-string "1.0.0" --hw-version 52 --sd-req 0xCA --key-file private.pem FW.zip
echo.
