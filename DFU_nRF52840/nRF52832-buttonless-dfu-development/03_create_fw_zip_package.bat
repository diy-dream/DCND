...
nrfutil pkg generate --application %APPLICATION_HEX% --application-version 1 --application-version-string "1.0.0" --hw-version 52 --sd-req 0xCA --sd-id 0xCA --softdevice %S132% --key-file private.pem FW.zip
echo.
